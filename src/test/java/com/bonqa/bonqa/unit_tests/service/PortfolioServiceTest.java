...
class PortfolioServiceTest {
    ...
    void testUpdatePortfolioStockValue() {
        portfolio.setStocks(new ArrayList<>(List.of(portfolioStock)));
        when(portfolioRepository.findById(anyLong())).thenReturn(Optional.of(portfolio));
        when(tradeRepository.findByPortfolioIdAndStockId(anyLong(), anyLong())).thenReturn(List.of(trade));
    ...
    void testUpdatePortfolioStockValueWithNull() {
        ...
        assertThrows(
                IllegalArgumentException.class, () -> portfolioService.updatePortfolioStockValue(null, portfolioStock));
    }
    ...
    void testUpdateAccountBalanceNegative() {
        ...
        assertThrows(
                ...
                () -> portfolioService.updateAccountBalance(portfolio, negativeBalanceChange));
    }
}
