...
import com.bonqa.bonqa.utility.HandleUserInput;
import com.bonqa.bonqa.utility.PatternMatching;
import com.bonqa.bonqa.utility.UserInput;
import com.bonqa.bonqa.model.Account;
import com.bonqa.bonqa.model.Customer;
import com.bonqa.bonqa.model.Transaction;
...
public class Controller {
    ...
    public Customer login() {
        ...
        while (!userNameExists(username) || !PatternMatching.validUserName(username) || findCustomer(username) == null) {
...
//        LocalDate birthDate = HandleUserInput.enterBirthdate();
//        String username = HandleUserInput.chooseUsername();
//        while (userNameExists(username)) {
//            username = HandleUserInput.chooseUsername();
//        }
//        String password = HandleUserInput.choosePassword();
//        String fullName = HandleUserInput.enterFullName();
//        Customer.Gender gender = HandleUserInput.chooseGender();
